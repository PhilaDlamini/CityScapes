 ...
 *
 */
public class PartiallyFilled implements Theme {
	...
	public Paint getWindowStroke() {
		Color[] choices = new Color[] {Color.WHITE, buildingColor};
		return choices[Computations.randomInRange(0, choices.length - 1)];
	}
